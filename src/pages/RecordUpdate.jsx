...
export const RecordUpdate = () => {
  ...
  const getSingleUserData = async () => {
    try {
      ...
      console.log(`Forms single Data: ${data}`);

      // Remove DateTime field from data
      ...
      <body className="back">
        <div className="back2">
          <form onSubmit={handleSubmit}>
            ...
            <div className="element">
              Name of the person filling form
              <br />
              <input
                className="box"
                type="text"
            ...
            <div className="element">
              ...
              <div className="box1">
                ...
                <input
                  ...
                  name="Type_of_form"
                  value="Geriatric"
                  checked={user.Type_of_form === "Geriatric"}
                />
                Geriatric
                <input
                  className="radio"
                  ...
                  checked={user.Type_of_form === " Seva Arogya Camp"}
                />
                Seva Arogya Camp
              </div>
            </div>
            <div className="element">
              ...
              <div className="box1">
                <input
                  ...
                  value="Old"
                  checked={user.Type_of_paitent === "Old"}
                />
                Old
                <input
                  className="radio"
                  ...
                  name="Type_of_paitent"
                  value="New"
                  checked={user.Type_of_paitent === "New"}
                />
                New
              </div>
              <br />
            ...
            <div className="element">
              ...
              <div className="box1">
                ...
                <input
                  ...
                  name="SwellinG"
                  value="NonPitting"
                  checked={user.SwellinG === "NonPitting"}
                />
                Non Pitting
              </div>
            </div>
            ...
            <div className="deformities" style={{ height: "250px" }}>
              ...
              <div className="medical-box" style={{ height: "180px" }}>
                <input
                  ...
                  value="Upper Class"
                  onChange={handleInput}
                  checked={user.KuppuSwamy_Scale === "Upper Class"}
                />
                Upper class
                <br />
                <input
                  ...
                  onChange={handleInput}
                  name="KuppuSwamy_Scale"
                  checked={user.KuppuSwamy_Scale === "Upper-Middle Class"}
                />
                Upper-Middle Class
                <br />
                <input
                  ...
                  checked={user.KuppuSwamy_Scale === "Lower-Middle Class"}
                />
                Lower-Middle Class
                <br />
                <input
                  ...
                  value="Lower Class"
                  onChange={handleInput}
                  checked={user.KuppuSwamy_Scale === "Lower Class"}
                />
                Lower Class
                <br />
              </div>
